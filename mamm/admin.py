...
from .models import Stuff, MedicalHistory, MedicalHistoryAdmin, Patient, PatientAdmin, MedicalHistoryExcel, MedicalHistoryExcelAdmin, MedicalHistoryExcelTemplate, PatientOnlyPhone, PatientOnlyPhoneAdmin


admin.site.register(Stuff)
admin.site.register(MedicalHistory, MedicalHistoryAdmin)
admin.site.register(Patient, PatientAdmin)
admin.site.register(PatientOnlyPhone, PatientOnlyPhoneAdmin)
